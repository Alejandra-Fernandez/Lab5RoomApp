    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Boolean check=touritsSpotDao.is_exist(Integer.parseInt(t1.getText().toString()));
                if(check==false) {
                    touritsSpotDao.insertrecord(new TouristSpot(Integer.parseInt(t1.getText().toString()), t2.getText().toString(), t3.getText().toString()));
                    t1.setText("");
                    t2.setText("");
                    t3.setText("");
